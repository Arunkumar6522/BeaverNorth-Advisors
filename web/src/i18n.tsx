...
const en: Dict = {
  ...
  hero_tag: '#1 Canadian insurance and financial services partner',
  ...
  about_body: 'BeaverNorth Financials is a Canadian insurance and financial services firm focused on clarity and trust. Our mission is to simplify insurance decisions with transparent guidance and tailored recommendations.',
  ...
  footer_tag: 'Canada‑based insurance and financial services firm',
...
const fr: Dict = {
  ...
  hero_tag: "Partenaire canadien en assurance et services financiers n°1",
  ...
  about_body: "BeaverNorth Financials est une firme canadienne d'assurance et de services financiers axée sur la clarté et la confiance. Notre mission est de simplifier les décisions d'assurance avec des recommandations transparentes et adaptées.",
  ...
  footer_tag: 'Firme canadienne d\'assurance et de services financiers',
